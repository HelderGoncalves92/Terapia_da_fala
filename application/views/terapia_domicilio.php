	...
	<section class='block well'>
		<div class='header'>
			...
			<div id='contend' class=''>
				...
				<p>A qualidade de vida é um direito. Há muitas pessoas, que não se podem deslocar a Hospitais ou a Centros ou Clínicas onde estas estão disponíveis. Neste caso, torna-se pertinente que haja um serviço de Apoio ao Domicílio que permita ao paciente ter um tratamento adequado de alguém que o saberá compreender e ajudar a ultrapassar as suas dificuldades de comunicação e auto-estima, assim como à família, que é importante e essencial no desenrolar do desenvolvimento / recuperação do paciente, para que aos poucos, dê os resultados pretendidos, dentro do quadro de cada paciente.</p>
